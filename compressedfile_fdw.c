/*-------------------------------------------------------------------------
 *
 * compressedfile_fdw.c
 *        foreign-data wrapper for server-side compressed files (currently gzip).
 *
 * IDENTIFICATION
 *        contrib/compressedfile_fdw/compressedfile_fdw.c
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
 ...
 * SQL functions
 */
extern Datum compressedfile_fdw_handler(PG_FUNCTION_ARGS);
extern Datum compressedfile_fdw_validator(PG_FUNCTION_ARGS);

PG_FUNCTION_INFO_V1(compressedfile_fdw_handler);
PG_FUNCTION_INFO_V1(compressedfile_fdw_validator);
 ...
 */
	Datum
compressedfile_fdw_handler(PG_FUNCTION_ARGS)
{
 ...
 */
	Datum
compressedfile_fdw_validator(PG_FUNCTION_ARGS)
{
